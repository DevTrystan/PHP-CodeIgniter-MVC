								...
								echo '<ul class="page-breadcrumb wow bounceInRight animated" ata-wow-delay="0.4s">';
								 ...
								 if (is_home() || is_front_page()) :
									...
									// Blog Day
										...
										echo '<li class="active"><a href="'. esc_url(spicepress_curPageURL()) .'">'. get_the_time( esc_html__( 'd', 'spicepress' ) ) .'</a></li>';

									// Blog Month
									} elseif ( is_month() ) {
										echo '<li class="active"><a href="' . get_year_link(get_the_time( esc_html__( 'Y', 'spicepress' ) )) . '">' . get_the_time( esc_html__( 'Y', 'spicepress' ) ) . '</a>';
										echo '<li class="active"><a href="'. esc_url(spicepress_curPageURL()) .'">'. get_the_time( esc_html__( 'F', 'spicepress' ) ) .'</a></li>';

									// Blog Year
									} elseif ( is_year() ) {
										echo '<li class="active"><a href="'. esc_url(spicepress_curPageURL()) .'">'. get_the_time( esc_html__( 'Y', 'spicepress' ) ) .'</a></li>';
